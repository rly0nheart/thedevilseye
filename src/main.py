...
parser.add_argument('-d','--dump', metavar=f'{white}path/to/filename{reset}', help=f'{white}dump output to a file{reset}')
parser.add_argument('--version',version=f'{white}2022.1.0.0-hellfire Released on 23rd January 2022{reset}',action='version')
